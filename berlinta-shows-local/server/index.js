...
async function openaiArtistChat(formState, userMessage, locale, mode) {
  ...
  const basePrompt = locale === 'de'
    ? 'Du hilfst Künstlern, ihre Show anzumelden. Antworte kurz und freundlich. Gib konkrete Extraktionen als JSON: { "showTitle": "...", "shortDescriptionFacts": "...", "artistGenre": "...", "priceText": "...", "durationMinutes": number, "artistBio": "...", "submitterEmail": "..." }. '
    : 'You help artists register their show. Reply briefly and warmly. Give concrete extractions as JSON: { "showTitle": "...", "shortDescriptionFacts": "...", "artistGenre": "...", "priceText": "...", "durationMinutes": number, "artistBio": "...", "submitterEmail": "..." }. ';
  const completion = await openai.chat.completions.create({
    model: 'gpt-4o-mini',
    messages: [
